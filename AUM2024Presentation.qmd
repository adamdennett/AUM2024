...
[(the below formatting is not working!! I want the four seasons to take up the whole page; the code below SHOULD do that)]: #
...
*'Less methods looking for problems, rather the other way round' - Alex Singleton, 2024*

-   We need to consider what transport interaction models are built to do, and **why it is** that a given model is the best way of answering a question.
...
[want to move this over so text is left, img is right; please assist?]: #

![](images/all_STBs.png){align=right height=40% width=40%}

## Research question

[(the below formatting is not working!! I want the research q to take up the whole page; the code below SHOULD do that)]: #

::: {.r-fit-text}
How do the **simulated** **regional** transport planning interventions that are likely to be the most persuasive in securing government funding, and the most effective in suppressing unacceptable **inequities** between individuals in transport, perform in relation to reaching **net zero**?
:::
